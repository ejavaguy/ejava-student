...
ejb:(ear)/(module)/(distinctName)/(ejbClass)!(remoteInterface)?stateful
     ...
     */
    public static final String EAR_EJBCLIENT_JNDINAME = System.getProperty("jndi.name.ejbclient.ear",
    		"ejb:ejb-basic-ear/ejb-basic-ejb/GreeterEJB!" + GreeterRemote.class.getName());

    /**
     * Initializes the parent class to use EJB Client technique and EAR deployment. 
     */
    @Override
