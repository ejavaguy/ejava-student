...
/**
 * This class sets up the base IT test to use EJB Client and access
 * the WAR-deployed EJB.
 */
public class GreeterEJBClientWARIT extends GreeterBase {
    public static final String WAR_EJBCLIENT_JNDINAME = System.getProperty("jndi.name.ejbclient.war",
    		"ejb:/ejb-basic-war/GreeterEJB!" + GreeterRemote.class.getName());
