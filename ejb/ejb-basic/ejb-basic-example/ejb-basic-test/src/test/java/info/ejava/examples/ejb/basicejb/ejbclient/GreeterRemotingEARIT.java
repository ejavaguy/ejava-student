...
public class GreeterRemotingEARIT extends GreeterBase {
     ...
     */
    public static final String EAR_REMOTING_JNDINAME = System.getProperty("jndi.name.remoting.ear",
    		"ejb-basic-ear/ejb-basic-ejb/GreeterEJB!" + GreeterRemote.class.getName());

    /**
     * Initializes the parent class' to use JBoss Remoting and access EAR deployment. 
     */
    @Override
