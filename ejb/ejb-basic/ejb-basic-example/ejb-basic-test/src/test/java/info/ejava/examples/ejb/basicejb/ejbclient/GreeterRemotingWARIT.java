...
/**
 * This class sets up the base IT test to use JBoss Remoting and access the WAR-based
 * EJB deployment.
 */
public class GreeterRemotingWARIT extends GreeterBase {
    public static final String WAR_REMOTING_JNDINAME = System.getProperty("jndi.name.remoting.war",
    		"ejb-basic-war/GreeterEJB!" + GreeterRemote.class.getName());
