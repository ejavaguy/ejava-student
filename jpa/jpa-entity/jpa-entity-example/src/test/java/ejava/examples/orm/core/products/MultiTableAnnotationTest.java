...
public class MultiTableAnnotationTest extends TestBase {
    private static final Logger logger = LoggerFactory.getLogger(MultiTableAnnotationTest.class);
    
    /**
     */
    @Test
    public void testMultiTable() {
        logger.info("testMultiTable");
        ...
        logger.info("found watch: {}", watch2);
        ...
        em.remove(watch2);
        logger.info("removed watch: {}", watch);
        ...
        em.persist(watch3);
        logger.info("created leftover watch: {}", watch3);
    }        
}
